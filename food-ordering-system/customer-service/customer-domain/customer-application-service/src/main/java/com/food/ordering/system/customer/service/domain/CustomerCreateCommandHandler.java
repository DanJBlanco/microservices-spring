...
public class CustomerCreateCommandHandler {
    ...
    public CustomerCreatedEvent createCustomer(CreateCustomerCommand createCustomerCommand){
        ...
        if (savedCustomer == null){
            ...
            throw new CustomerDomainException("Could not save customer with id: " + createCustomerCommand.getCustomerId() + " createCustomerCommand.getCustomerId");
        }

        log.info("Returing CustomerCreatedEvent for customer id: {}", createCustomerCommand.getCustomerId());
