    ...
    public void publish(OrderApprovalOutboxMessage orderApprovalOutboxMessage,
        ...
        try {
            RestaurantApprovalRequestAvroModel restaurantApprovalRequestAvroModel =
                    orderMessagingDataMapper.orderPaymentEventToRestaurantApprovalRequestAvroModel(
            ...
            log.error("Error while sending OrderApprovalEventPayload to kafka with "
                    + "order id:{} and saga id: {}, error: {}", orderApprovalEventPayload.getOrderId(), sagaId, e.getMessage());
        }
