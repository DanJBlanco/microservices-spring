...
@Slf4j
@RestController
@RequestMapping(value = "/orders", produces = "application/vnd.api")
public class OrderController {
    ...
    public ResponseEntity<?> createOrder(@RequestBody CreateOrderCommand createOrderCommand) {
        log.info("Creating order for customer: {} at restaunrant: {}", createOrderCommand.getCustomerId(),
    ...
    public ResponseEntity<?> getOrderByTracking(@PathVariable UUID trackingId){
